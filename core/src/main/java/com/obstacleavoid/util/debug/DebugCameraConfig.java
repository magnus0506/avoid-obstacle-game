...
public class DebugCameraConfig {
    ...
    private static final int DEFAULT_ZOOM_IN_KEY = Input.Keys.UP;
    private static final int DEFAULT_ZOOM_OUT_KEY = Input.Keys.DOWN;
    private static final int DEFAULT_RESET_KEY = Input.Keys.LEFT;
    private static final int DEFAULT_LOG_KEY = Input.Keys.RIGHT;
